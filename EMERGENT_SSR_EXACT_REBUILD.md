...
```bash
REACT_APP_BACKEND_URL=https://video-autoplay-fix-3.preview.emergentagent.com
PORT=3000
```
...
autostart=true
autorestart=true
environment=NODE_ENV=production,REACT_APP_BACKEND_URL=https://video-autoplay-fix-3.preview.emergentagent.com
...
- Preview: https://video-autoplay-fix-3.preview.emergentagent.com
- Backend: https://video-autoplay-fix-3.preview.emergentagent.com/api
- Sitemap: https://video-autoplay-fix-3.preview.emergentagent.com/sitemap.xml
