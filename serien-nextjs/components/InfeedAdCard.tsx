 ...
 * Slot. Die gemeinsame Desktop-Prüfung verhindert auch unsichtbare Requests.
 *
...
export default function InfeedAdCard({ position = 'news_infeed' }: InfeedAdCardProps) {
  return (
    <DesktopOnlyAds>
      <div
        className="hidden lg:flex bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden items-center justify-center min-h-[280px] empty:hidden"
