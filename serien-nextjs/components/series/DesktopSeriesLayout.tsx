              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                {characters.map((character: any) => (
                  ...
                  >
                    ...
                    <p className="font-semibold text-sm text-gray-900 dark:text-white line-clamp-2 group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors">
                      {character.name}
                    </p>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                ...
                <ul className="space-y-2">
                  {cast.slice(0, 8).map((actor: any) => (
                    <li key={actor.id || actor.name} className="text-sm text-gray-900 dark:text-white">
                      <span className="font-medium">{actor.name}</span>
                      {actor.character && (
                        <span className="text-xs text-gray-500 dark:text-gray-400"> · als {actor.character}</span>
                      )}
                    </li>
                  ))}
                </ul>
