...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Observing the dashboard must never mutate runs. A bounded editorial
    // retry/revision can legitimately exceed ten minutes; age is not proof
    // that its worker stopped. Lifecycle changes belong to the owning worker.
