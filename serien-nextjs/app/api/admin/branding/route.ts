...
const SLOTS: Slot[] = [
  ...
  },
  {
    ...
    description: 'Google-News / Artikel-Rich-Results Publisher-Logo. Breit 600×60, transparenter PNG-Hintergrund bevorzugt.',
    publicPath: 'logo.png',
    recommendedWidth: 600, recommendedHeight: 60,
    recommendedNote: '600×60 PNG mit Transparenz',
    acceptedMimes: ['image/png'],
    acceptedExts: ['.png'],
    maxSizeBytes: 500 * 1024,
  },
  {
    ...
    description: 'Logo-Variante für dunkle Hintergründe (Footer, Dark Mode, OG-Overlay). Weißer Text auf transparent.',
  ...
  {
    id: 'logo-square',
    label: 'Logo Square (Social Avatar)',
    description: 'Für Social-Media-Profile (Facebook, Twitter, LinkedIn) und manifest.json. 512×512 PNG.',
