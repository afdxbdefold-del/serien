...
// ads.txt — IAB-spec authorized digital sellers list.
//   - OWNERDOMAIN/MANAGERDOMAIN declarations (case-insensitive per spec)
//   - Google AdSense DIRECT entry (`pub-8583619451045805`) MUST stay at top —
