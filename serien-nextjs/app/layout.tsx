      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){var isDesktop=window.matchMedia&&window.matchMedia('(min-width: 1024px)').matches;var isPrebidTest=window.location.pathname.indexOf('/adtest-')===0;if(isDesktop||isPrebidTest){/* InMobi Choice. Consent Manager Tag v3.0 (for TCF 2.3) */
