/**
 * Discovery+ Serien Hub - Pillar Page for Topical Authority
 * URL: /discovery-plus-serien
 * 
 * Comprehensive hub for all Discovery+ series including:
 * - Trending series
 * - New releases
 * - Latest news/reviews
 * - All Discovery+ series catalog
 */
...
export const metadata: Metadata = {
  title: 'Discovery+ Serien 2026: Neue Releases, Trends & Reviews | serien.de',
  description: 'Entdecke alle Discovery+ Serien 2026: Neue Releases, Trending Shows, Reviews und News. Dein vollständiger Guide zu den besten Discovery+ Originals und Exklusiv-Serien.',
  keywords: ['Discovery+ Serien', 'Discovery+ 2026', 'Discovery+ Neue Serien', 'Discovery+ Originals', 'Discovery+ Deutschland', 'Streaming Serien'],
  openGraph: {
    title: 'Discovery+ Serien 2026: Neue Releases, Trends & Reviews',
    description: 'Dein vollständiger Guide zu allen Discovery+ Serien - Neue Releases, Trends, Reviews und exklusive News.',
    type: 'website',
    url: '/discovery-plus-serien',
  },
  alternates: {
    canonical: 'https://serien.de/discovery-plus-serien',
  },
};
...
const getDiscoveryPlusData = unstable_cache(
  ...
  ['discovery-plus-hub-data'],
  { revalidate: 600, tags: ['discovery-plus-hub'] }
);

// Schema.org structured data
function generateDiscoveryPlusHubSchema() {
  return {
    ...
    breadcrumb: {
      ...
      itemListElement: [
        ...
        },
        {
          '@type': 'ListItem',
          position: 2,
          name: 'Discovery+ Serien',
          item: 'https://serien.de/discovery-plus-serien'
        }
      ]
    }
  };
...
export default async function DiscoveryPlusSerienPage() {
  const { allDiscoveryPlusSeries, discoveryPlusArticles, trendingArticles, recentSeries } = await getDiscoveryPlusData();

  const hubSchema = generateDiscoveryPlusHubSchema();
  ...
  const topRatedSeries = [...allDiscoveryPlusSeries]
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50 dark:bg-[hsl(230,25%,7%)]">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-blue-500 via-blue-700 to-slate-900 dark:from-red-900 dark:via-red-950 dark:to-black overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 py-16 sm:py-24">
            <div className="text-center">
              ...
              <p className="text-lg sm:text-xl text-white/80 max-w-2xl mx-auto mb-8">
                Dein vollständiger Guide zu allen Discovery+ Originals und Exklusiv-Serien. 
              ...
              <div className="flex flex-wrap justify-center gap-8 mt-10">
                <div className="text-center">
                  <div className="text-3xl sm:text-4xl font-bold text-white">{allDiscoveryPlusSeries.length}+</div>
                  <div className="text-sm text-white/60 mt-1">Serien</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl sm:text-4xl font-bold text-white">{discoveryPlusArticles.length}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 space-y-16">
          ...
          {trendingArticles.length > 0 && (
            <section>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Trending auf Discovery+</h2>
              </div>
            ...
            <section>
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Neue Discovery+ Serien</h2>
                </div>
              </div>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {discoveryPlusArticles.slice(0, 6).map((article) => {
            ...
            {discoveryPlusArticles.length > 6 && (
          ...
          {topRatedSeries.length > 0 && (
            <section>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Top Bewertete Discovery+ Serien</h2>
              </div>
          ...
          <section>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Alle Discovery+ Serien</h2>
              </div>
              <span className="text-sm text-gray-500 dark:text-gray-400">
                {allDiscoveryPlusSeries.length} Serien
              </span>
            </div>
            
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-8 gap-3 sm:gap-4">
              {allDiscoveryPlusSeries.map((series) => (
                <Link
                  key={series.tmdbId}
                  href={`/serie/${series.slug}`}
                  className="group"
          ...
          <section className="bg-white dark:bg-[hsl(230,25%,10%)] rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-800">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
              Discovery+ Serien: Alles was du wissen musst
            </h2>
            
            <div className="prose prose-gray dark:prose-invert max-w-none">
              <p>
                Discovery+ hat sich seit seiner Gründung zu einem der führenden Streaming-Dienste weltweit entwickelt. 
                Mit einer beeindruckenden Bibliothek von <strong>Discovery+ Originals</strong> und exklusiven Lizenzserien 
                bietet die Plattform für jeden Geschmack das passende Format.
              </p>
              
              <h3>Was macht Discovery+ Serien besonders?</h3>
              <p>
                Discovery+ investiert jährlich Milliarden in die Produktion eigener Inhalte. Von preisgekrönten Dramen 
                wie <em>Stranger Things</em> und <em>The Crown</em> bis hin zu internationalen Hits wie 
                <em>Squid Game</em> und <em>Dark</em> – Discovery+ Originals setzen regelmäßig neue Maßstäbe 
                in der Serienlandschaft.
              </p>
              
              <h3>Discovery+ in Deutschland</h3>
              <p>
                Der deutsche Markt ist für Discovery+ besonders wichtig. Neben internationalen Produktionen 
                finden sich immer mehr deutsche Discovery+ Originals wie <em>Dark</em>, <em>How to Sell Drugs Online (Fast)</em> 
                und <em>Barbaren</em> im Programm. Diese Serien haben nicht nur in Deutschland, 
                sondern weltweit Erfolge gefeiert.
              </p>
              
              <h3>Neue Discovery+ Serien 2026</h3>
              <p>
                Auch 2026 erwarten uns zahlreiche neue Discovery+ Serien. Von lang erwarteten Fortsetzungen 
                bis hin zu völlig neuen Formaten – auf dieser Seite findest du alle aktuellen News, 
                Release-Termine und Reviews zu den neuesten Discovery+ Produktionen.
              </p>
            </div>
          </section>
