/**
 * HBO Max Serien Hub - Pillar Page for Topical Authority
 * URL: /hbo-serien
 * 
 * Comprehensive hub for all HBO Max series including:
 * - Trending series
 * - New releases
 * - Latest news/reviews
 * - All HBO Max series catalog
 */
...
export const metadata: Metadata = {
  title: 'HBO Max Serien 2026: Neue Releases, Trends & Reviews | serien.de',
  description: 'Entdecke alle HBO Max Serien 2026: Neue Releases, Trending Shows, Reviews und News. Dein vollständiger Guide zu den besten HBO Originals und Exklusiv-Serien.',
  keywords: ['HBO Max Serien', 'HBO Max 2026', 'HBO Max Neue Serien', 'HBO Originals', 'HBO Max Deutschland', 'Streaming Serien'],
  openGraph: {
    title: 'HBO Max Serien 2026: Neue Releases, Trends & Reviews',
    description: 'Dein vollständiger Guide zu allen HBO Max Serien - Neue Releases, Trends, Reviews und exklusive News.',
    type: 'website',
    url: '/hbo-serien',
  },
  alternates: {
    canonical: 'https://serien.de/hbo-serien',
  },
};
...
const getHBOData = unstable_cache(
  ...
  ['hbo-hub-data'],
  { revalidate: 600, tags: ['hbo-hub'] }
);

// Schema.org structured data
function generateHBOHubSchema() {
  return {
    ...
    breadcrumb: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 2,
          name: 'HBO Max Serien',
          item: 'https://serien.de/hbo-serien'
        }
      ]
    }
  };
...
export default async function HBOSerienPage() {
  ...
  const topRatedSeries = [...allHBOSeries]
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50 dark:bg-[hsl(230,25%,7%)]">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-purple-700 via-indigo-800 to-black dark:from-red-900 dark:via-red-950 dark:to-black overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 py-16 sm:py-24">
            <div className="text-center">
              ...
              <p className="text-lg sm:text-xl text-white/80 max-w-2xl mx-auto mb-8">
                Dein vollständiger Guide zu allen HBO Originals und Exklusiv-Serien. 
              ...
              <div className="flex flex-wrap justify-center gap-8 mt-10">
                <div className="text-center">
                  <div className="text-3xl sm:text-4xl font-bold text-white">{allHBOSeries.length}+</div>
                  <div className="text-sm text-white/60 mt-1">Serien</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl sm:text-4xl font-bold text-white">{hboArticles.length}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 space-y-16">
          ...
          {trendingArticles.length > 0 && (
            <section>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Trending auf HBO Max</h2>
              </div>
                ...
                {trendingArticles.map((article, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Rank Badge */}
                      <div className="absolute top-2 left-2 w-8 h-8 bg-purple-600 rounded-full flex items-center justify-center font-bold text-white text-sm shadow-lg">
                        {index + 1}
                      </div>
                      
                      <div className="absolute bottom-0 left-0 right-0 p-3">
                        <p className="text-white font-semibold text-sm line-clamp-2 group-hover:text-purple-400 transition-colors">
                          {article.title}
                        </p>
                      </div>
                    </Link>
            ...
            <section>
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Neue HBO Max Serien</h2>
                </div>
              </div>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {hboArticles.slice(0, 6).map((article) => {
                ...
                return (
                  ...
                  >
                    <div className="relative aspect-video overflow-hidden">
                      ...
                      {/* HBO Max Badge */}
                      <div className="absolute top-3 right-3 bg-purple-600 text-white text-xs font-bold px-2 py-1 rounded shadow">
                        HBO Max
                      </div>
                    </div>
            ...
            {hboArticles.length > 6 && (
              <div className="text-center mt-8">
                <Link
                  href="/?filter=HBO Max"
                  className="inline-flex items-center gap-2 bg-purple-600 hover:bg-red-700 text-white font-semibold px-6 py-3 rounded-lg transition-colors"
                >
                  Alle HBO Max News anzeigen
          ...
          {topRatedSeries.length > 0 && (
            <section>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Top Bewertete HBO Max Serien</h2>
              </div>
          ...
          <section>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-red-100 dark:bg-purple-500/20 rounded-lg">
                  <Play className="w-5 h-5 text-purple-600 dark:text-purple-400" />
                </div>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Alle HBO Max Serien</h2>
              </div>
              <span className="text-sm text-gray-500 dark:text-gray-400">
                {allHBOSeries.length} Serien
              </span>
            </div>
            
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-8 gap-3 sm:gap-4">
              {allHBOSeries.map((series) => (
                <Link
                  key={series.tmdbId}
                  href={`/serie/${series.slug}`}
                  className="group"
                >
                  ...
                  <p className="mt-2 text-xs sm:text-sm font-medium text-gray-900 dark:text-white line-clamp-2 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                    {series.name || series.title}
                  </p>
                </Link>
              ))}
          ...
          <section className="bg-white dark:bg-[hsl(230,25%,10%)] rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-800">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
              HBO Max Serien: Alles was du wissen musst
            </h2>
            
            <div className="prose prose-gray dark:prose-invert max-w-none">
              <p>
                HBO Max hat sich seit seiner Gründung zu einem der führenden Streaming-Dienste weltweit entwickelt. 
                Mit einer beeindruckenden Bibliothek von <strong>HBO Originals</strong> und exklusiven Lizenzserien 
                bietet die Plattform für jeden Geschmack das passende Format.
              </p>
              
              <h3>Was macht HBO Max Serien besonders?</h3>
              <p>
                HBO Max investiert jährlich Milliarden in die Produktion eigener Inhalte. Von preisgekrönten Dramen 
                wie <em>Stranger Things</em> und <em>The Crown</em> bis hin zu internationalen Hits wie 
                <em>Squid Game</em> und <em>Dark</em> – HBO Originals setzen regelmäßig neue Maßstäbe 
                in der Serienlandschaft.
              </p>
              
              <h3>HBO Max in Deutschland</h3>
              <p>
                Der deutsche Markt ist für HBO Max besonders wichtig. Neben internationalen Produktionen 
                finden sich immer mehr deutsche HBO Originals wie <em>Dark</em>, <em>How to Sell Drugs Online (Fast)</em> 
                und <em>Barbaren</em> im Programm. Diese Serien haben nicht nur in Deutschland, 
                sondern weltweit Erfolge gefeiert.
              </p>
              
              <h3>Neue HBO Max Serien 2026</h3>
              <p>
                Auch 2026 erwarten uns zahlreiche neue HBO Max Serien. Von lang erwarteten Fortsetzungen 
                bis hin zu völlig neuen Formaten – auf dieser Seite findest du alle aktuellen News, 
                Release-Termine und Reviews zu den neuesten HBO Max Produktionen.
              </p>
            </div>
          </section>
