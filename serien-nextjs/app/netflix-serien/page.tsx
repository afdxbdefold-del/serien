/**
 * Netflix Serien Hub - Pillar Page for Topical Authority
 * URL: /netflix-serien
 * 
 * Comprehensive hub for all Netflix series including:
 * - Trending series
 * - New releases
 * - Latest news/reviews
 * - All Netflix series catalog
 */
...
export const metadata: Metadata = {
  title: 'Netflix Serien 2026: Neue Releases, Trends & Reviews | serien.de',
  description: 'Entdecke alle Netflix Serien 2026: Neue Releases, Trending Shows, Reviews und News. Dein vollständiger Guide zu den besten Netflix Originals und Exklusiv-Serien.',
  keywords: ['Netflix Serien', 'Netflix 2026', 'Netflix Neue Serien', 'Netflix Originals', 'Netflix Deutschland', 'Streaming Serien'],
  openGraph: {
    title: 'Netflix Serien 2026: Neue Releases, Trends & Reviews',
    description: 'Dein vollständiger Guide zu allen Netflix Serien - Neue Releases, Trends, Reviews und exklusive News.',
    type: 'website',
    url: '/netflix-serien',
  },
  alternates: {
...
const getNetflixData = unstable_cache(
  async () => {
    const [
      allNetflixSeries,
      netflixArticles,
  ...
  ['netflix-hub-data'],
  { revalidate: 600, tags: ['netflix-hub'] }
);

// Schema.org structured data
function generateNetflixHubSchema() {
  return {
    '@context': 'https://schema.org',
    '@type': 'CollectionPage',
    name: 'Netflix Serien 2026',
    description: 'Vollständiger Guide zu allen Netflix Serien - Neue Releases, Trends und Reviews',
    url: 'https://serien.de/netflix-serien',
    publisher: {
      '@type': 'Organization',
      name: 'serien.de',
      url: 'https://serien.de'
    ...
    breadcrumb: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 2,
          name: 'Netflix Serien',
          item: 'https://serien.de/netflix-serien'
        }
      ]
    }
  };
...
export default async function NetflixSerienPage() {
  const { allNetflixSeries, netflixArticles, trendingArticles, recentSeries } = await getNetflixData();

  const hubSchema = generateNetflixHubSchema();
  ...
  const topRatedSeries = [...allNetflixSeries]
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50 dark:bg-[hsl(230,25%,7%)]">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-red-600 via-red-700 to-black dark:from-red-900 dark:via-red-950 dark:to-black overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 py-16 sm:py-24">
            <div className="text-center">
              ...
              <p className="text-lg sm:text-xl text-white/80 max-w-2xl mx-auto mb-8">
                Dein vollständiger Guide zu allen Netflix Originals und Exklusiv-Serien. 
              ...
              <div className="flex flex-wrap justify-center gap-8 mt-10">
                <div className="text-center">
                  <div className="text-3xl sm:text-4xl font-bold text-white">{allNetflixSeries.length}+</div>
                  <div className="text-sm text-white/60 mt-1">Serien</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl sm:text-4xl font-bold text-white">{netflixArticles.length}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 space-y-16">
          ...
          {trendingArticles.length > 0 && (
            <section>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Trending auf Netflix</h2>
              </div>
                ...
                {trendingArticles.map((article, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Rank Badge */}
                      <div className="absolute top-2 left-2 w-8 h-8 bg-red-600 rounded-full flex items-center justify-center font-bold text-white text-sm shadow-lg">
                        {index + 1}
                      </div>
                      
                      <div className="absolute bottom-0 left-0 right-0 p-3">
                        <p className="text-white font-semibold text-sm line-clamp-2 group-hover:text-red-400 transition-colors">
                          {article.title}
                        </p>
                      </div>
                    </Link>
            ...
            <section>
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Neue Netflix Serien</h2>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 sm:gap-6">
                {recentSeries.map((series) => (
                  ...
                  >
                    ...
                    <div className="mt-3">
                      <h3 className="font-semibold text-gray-900 dark:text-white line-clamp-1 group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {netflixArticles.slice(0, 6).map((article) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-4">
                      <h3 className="font-bold text-gray-900 dark:text-white line-clamp-2 group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors mb-2">
                        {article.title}
                      </h3>
          ...
          {topRatedSeries.length > 0 && (
            <section>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Top Bewertete Netflix Serien</h2>
              </div>
          ...
          <section>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Alle Netflix Serien</h2>
              </div>
              <span className="text-sm text-gray-500 dark:text-gray-400">
                {allNetflixSeries.length} Serien
              </span>
            </div>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-8 gap-3 sm:gap-4">
              {allNetflixSeries.map((series) => (
                ...
                >
                  ...
                  <p className="mt-2 text-xs sm:text-sm font-medium text-gray-900 dark:text-white line-clamp-2 group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors">
                    {series.name || series.title}
                  </p>
                </Link>
              ))}
          ...
          <section className="bg-white dark:bg-[hsl(230,25%,10%)] rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-800">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
              Netflix Serien: Alles was du wissen musst
            </h2>
            
            <div className="prose prose-gray dark:prose-invert max-w-none">
              <p>
                Netflix hat sich seit seiner Gründung zu einem der führenden Streaming-Dienste weltweit entwickelt. 
                Mit einer beeindruckenden Bibliothek von <strong>Netflix Originals</strong> und exklusiven Lizenzserien 
                bietet die Plattform für jeden Geschmack das passende Format.
              </p>
              
              <h3>Was macht Netflix Serien besonders?</h3>
              <p>
                Netflix investiert jährlich Milliarden in die Produktion eigener Inhalte. Von preisgekrönten Dramen 
                wie <em>Stranger Things</em> und <em>The Crown</em> bis hin zu internationalen Hits wie 
                <em>Squid Game</em> und <em>Dark</em> – Netflix Originals setzen regelmäßig neue Maßstäbe 
                in der Serienlandschaft.
              </p>
              
              <h3>Netflix in Deutschland</h3>
              <p>
                Der deutsche Markt ist für Netflix besonders wichtig. Neben internationalen Produktionen 
                finden sich immer mehr deutsche Netflix Originals wie <em>Dark</em>, <em>How to Sell Drugs Online (Fast)</em> 
                und <em>Barbaren</em> im Programm. Diese Serien haben nicht nur in Deutschland, 
                sondern weltweit Erfolge gefeiert.
              </p>
              
              <h3>Neue Netflix Serien 2026</h3>
              <p>
                Auch 2026 erwarten uns zahlreiche neue Netflix Serien. Von lang erwarteten Fortsetzungen 
                bis hin zu völlig neuen Formaten – auf dieser Seite findest du alle aktuellen News, 
                Release-Termine und Reviews zu den neuesten Netflix Produktionen.
              </p>
            </div>
          </section>
