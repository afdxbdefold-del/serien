    ...
    const response = await fetch(llmUrl, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'Erstelle 2-3 Fragen und Antworten zum Artikel auf Deutsch. Nur Fakten aus dem Text, keine Spekulation. JSON: {"questions":[{"question":"...","answer":"...","factual":true}]}'
          },
          {
            role: 'user',
    ...
    const response = await fetch(llmUrl, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `Serien-Analyst. Erstelle 5 INTERPRETATIVE Q&A-Paare (keine Fakten-Wiederholung wie "Wie viele Staffeln?"). Fokus: Genre-Einordnung, Zielgruppe, Stärken/Schwächen, Vergleiche. JSON: {"questions":[{"question":"...","answer":"...","factual":false}]}`
          },
          {
            role: 'user',
